...
resource "azurerm_dns_cname_record" "dkim_selector1" {
  ...
  resource_group_name = azurerm_resource_group.openinfrastructure_rg.name
  ttl                 = 3600
  record              = "selector1-openinfrastructure-de01b._domainkey.cedidev.onmicrosoft.com"
}
...
resource "azurerm_dns_cname_record" "dkim_selector2" {
  ...
  resource_group_name = azurerm_resource_group.openinfrastructure_rg.name
  ttl                 = 3600
  record              = "selector2-openinfrastructure-de01b._domainkey.cedidev.onmicrosoft.com"
}
